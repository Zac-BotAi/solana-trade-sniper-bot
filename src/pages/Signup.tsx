    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-indigo-900 via-purple-900 to-purple-800 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-6">
          ...
          <p className="text-purple-200">Join MemesEye and start trading meme tokens</p>
        </div>
            ...
            <div className="grid gap-4">
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <label
                    htmlFor="terms"
                    className="text-sm text-purple-200 leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                  >
                    I agree to the{" "}
